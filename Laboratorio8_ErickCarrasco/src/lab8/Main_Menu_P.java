...
public class Main_Menu_P extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jd_add_activity = new javax.swing.JDialog();
        jLabel3 = new javax.swing.JLabel();
        tf_nombre_actividad = new javax.swing.JTextField();
        jLabel4 = new javax.swing.JLabel();
        jLabel5 = new javax.swing.JLabel();
        js_duracion_ = new javax.swing.JSpinner();
        jLabel6 = new javax.swing.JLabel();
        js_posibilidad = new javax.swing.JSpinner();
        ...
        javax.swing.GroupLayout jd_add_activityLayout = new javax.swing.GroupLayout(jd_add_activity.getContentPane());
        jd_add_activity.getContentPane().setLayout(jd_add_activityLayout);
        jd_add_activityLayout.setHorizontalGroup(
            jd_add_activityLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(jd_add_activityLayout.createSequentialGroup()
                .addGroup(jd_add_activityLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jd_add_activityLayout.createSequentialGroup()
                        .addGap(30, 30, 30)
                        .addGroup(jd_add_activityLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        ...
                        .addGap(53, 53, 53)
                        .addGroup(jd_add_activityLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(tf_nombre_actividad, javax.swing.GroupLayout.PREFERRED_SIZE, 169, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addGroup(jd_add_activityLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                .addComponent(js_posibilidad, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 107, Short.MAX_VALUE)
                                .addComponent(js_duracion_, javax.swing.GroupLayout.Alignment.LEADING))))
                    .addGroup(jd_add_activityLayout.createSequentialGroup()
                        .addGap(109, 109, 109)
                        .addGroup(jd_add_activityLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(cb_actividades, javax.swing.GroupLayout.PREFERRED_SIZE, 155, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jd_add_activityLayout.setVerticalGroup(
            jd_add_activityLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(jd_add_activityLayout.createSequentialGroup()
                .addGap(10, 10, 10)
                .addComponent(jLabel4)
                .addGap(18, 18, 18)
                .addGroup(jd_add_activityLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel3)
                    .addComponent(tf_nombre_actividad, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
                .addGroup(jd_add_activityLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel5)
                    .addComponent(js_duracion_, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(28, 28, 28)
                .addGroup(jd_add_activityLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel6)
                    .addComponent(js_posibilidad, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(60, 60, 60)
    ...
    private void jb_crearactivityMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jb_crearactivityMouseClicked
        try {
            DefaultComboBoxModel modelo = (DefaultComboBoxModel) cb_main_proyects.getModel();
            modelo.addElement(cb_main_proyects.getSelectedIndex());
            if (((CrearProyecto) modelo.getElementAt(cb_main_proyects.getSelectedIndex())).getListaActividades().isEmpty()) {
                
            }else{
                DefaultComboBoxModel m = (DefaultComboBoxModel) cb_actividades.getModel();
                m.removeAllElements();
                for (int i = 0; i <((CrearProyecto) modelo.getElementAt(cb_main_proyects.getSelectedIndex())).getListaActividades().size() ; i++) {
                    m.addElement((Actividades) ((CrearProyecto) modelo.getElementAt(cb_main_proyects.getSelectedIndex())).getListaActividades().get(i));
                }
                m.addElement("None");
                cb_actividades.setModel(m);
                
            }
            jd_add_activity.setModal(true);
            jd_add_activity.pack();
            jd_add_activity.setLocationRelativeTo(this);
            jd_add_activity.setVisible(true);
        } catch (Exception e) {
        }
    ...
    private void jb_agregarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jb_agregarMouseClicked
        // TODO add your handling code here:
        DefaultComboBoxModel modelo = (DefaultComboBoxModel) cb_main_proyects.getModel();
        if (cb_actividades.getSelectedIndex()==0 || cb_actividades.getSelectedIndex()<0) {
            ((CrearProyecto) modelo.getElementAt(cb_main_proyects.getSelectedIndex())).getListaActividades().add(
                new Actividades(tf_nombre_actividad.getText(), (Integer)js_duracion_.getValue(), (Integer)js_posibilidad.getValue() ));
            
            ((CrearProyecto) modelo.getElementAt(cb_main_proyects.getSelectedIndex())).getListaActividades().get(
                ((CrearProyecto) modelo.getElementAt(cb_main_proyects.getSelectedIndex())).getListaActividades().size()-1).setInicio_temprano(1);
            
            cb_main_proyects.setModel(modelo);
            JOptionPane.showMessageDialog(jd_add_activity, "Actividad creada");
            
            
            jd_add_activity.setVisible(false);
            actualizar();
        }else{
            DefaultComboBoxModel m = (DefaultComboBoxModel) cb_actividades.getModel();
            ((CrearProyecto) modelo.getElementAt(cb_main_proyects.getSelectedIndex())).getListaActividades().add(
            ...
            ((CrearProyecto) modelo.getElementAt(cb_main_proyects.getSelectedIndex())).getListaActividades().get(
                ((CrearProyecto) modelo.getElementAt(cb_main_proyects.getSelectedIndex())).getListaActividades().size()-1).getActividadesSuc().add(
                (Actividades)m.getElementAt(cb_actividades.getSelectedIndex()));
            
            ((Actividades) m.getElementAt(cb_actividades.getSelectedIndex())).getActividadesPred().add(
                (Actividades)((CrearProyecto) modelo.getElementAt(cb_main_proyects.getSelectedIndex())).getListaActividades().get(
                    ((CrearProyecto) modelo.getElementAt(cb_main_proyects.getSelectedIndex())).getListaActividades().size()-1));
        ...
        jd_add_activity.dispose();
        tf_nombre_actividad.setText("");
    ...
    private javax.swing.JDialog jd_add_activity;
    private javax.swing.JDialog jd_create_project;
    private javax.swing.JDialog jd_project_editor;
    private javax.swing.JSpinner js_duracion_;
    private javax.swing.JSpinner js_posibilidad;
    private javax.swing.JTree jt_main;
    private javax.swing.JTree jt_projects_modify;
    private javax.swing.JTextField tf_nombre_actividad;
